      ...
      <div className='scroll-element'>
        ...
        <div id='bio'>
          <p>
            ...
            enraciné dans la charmante ville de Nîmes. À l'aube de ses 16 ans,
            il fait une découverte qui allait changer sa vie : la musique. Animé
            d'une passion dévorante, il s'immerge dans l'univers artistique en
            prenant des leçons de chant, de piano, de théâtre, de danse et même
            de comédie musicale.
          </p>
          <p>
            ...
            rôle de pianiste. Cette collaboration fructueuse donne naissance à
            un premier EP intitulé "Lemonade". L'un des moments marquants est la
          ...
          <p>
            ...
            aventure créative, bâtie sur les fondations de la collaboration et
            du partage.
          </p>
        </div>
      </div>
